CREATE TABLE IF NOT EXISTS Album (
    ...
    CONSTRAINT uq_album_name_release_year UNIQUE (album_name, release_year)
...
CREATE TABLE IF NOT EXISTS Track (
    ...
    CONSTRAINT uq_track_name_duration UNIQUE (track_name, duration)
);

CREATE TABLE IF NOT EXISTS Singer (
    singer_id SERIAL PRIMARY KEY,
    singer_name VARCHAR(150) NOT NULL,
    CONSTRAINT uq_singer_name UNIQUE (singer_name)
);
...
CREATE TABLE IF NOT EXISTS Collection (
    ...
    CONSTRAINT uq_collection_name_release_year UNIQUE (collection_name, release_year)
);
